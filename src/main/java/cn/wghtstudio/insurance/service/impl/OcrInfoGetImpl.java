...
public class OcrInfoGetImpl implements OcrInfoService {
	...
	@Override
	public InsuranceDocumentResponseBody GetInsuranceDocumentService(String imgUrl) throws OcrTokenGetErrorException, JsonPraseErrorException {
		...
		try {
			...
			e.printStackTrace();
			throw new JsonPraseErrorException();
		}
	}
	
	@Override
	public IdCardResponseBody GetIdCardInfoService(String imgUrl) throws OcrTokenGetErrorException, JsonPraseErrorException {
		String token = ocrTokenGet.getAuth();
		if (token == null || token.length() == 0) {
			throw new OcrTokenGetErrorException();
		}
	...
	@Override
	public BussyLicenseResponseBdoy GetBussyLicenseInfoService(String imgUrl) throws OcrTokenGetErrorException, JsonPraseErrorException {
		String token = ocrTokenGet.getAuth();
		if (token == null || token.length() == 0) {
			throw new OcrTokenGetErrorException();
		}
	...
	public DriveLicenseResponseBody GetDriveLicenseInfoService(String imgUrl) throws OcrTokenGetErrorException, JsonPraseErrorException {
		String token = ocrTokenGet.getAuth();
		if (token == null || token.length() == 0) {
			throw new OcrTokenGetErrorException();
		}
	...
	public CertificateResponseBody GetCertificateInfoService(String imgUrl) throws OcrTokenGetErrorException, JsonPraseErrorException {
		String token = ocrTokenGet.getAuth();
		if (token == null || token.length() == 0) {
			throw new OcrTokenGetErrorException();
		}
